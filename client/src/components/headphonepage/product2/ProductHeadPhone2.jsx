...
import HeadPhone2Desktop from "../../../assets/product-xx99-mark-one-headphones/desktop/image-product.jpg";
import HeadPhone2Tablet from "../../../assets/product-xx99-mark-one-headphones/tablet/image-product.jpg";
import HeadPhone2Mobile from "../../../assets/product-xx99-mark-one-headphones/mobile/image-product.jpg";
      ...
      <div>
        ...
        <div className=" max-w-[1110px] w-[90%] lg:w-[80%] mx-auto my-16 hero rounded-none  flex gap-16 flex-col md:flex-row lg:flex-row ">
          ...
          <div className=" lg:w-[45%]   mx-auto  flex flex-col gap-4   lg:text-start ">
            ...
            <h2 className=" h2 hero-title">XX99 MARK I Headphones</h2>
            <p className="body">
            As the gold standard for headphones, the classic XX99 Mark I offers detailed and accurate audio reproduction for audiophiles, mixing engineers, and music aficionados alike in studios and on the go.
            </p>
            <h6 className="h6">$1,750</h6>
